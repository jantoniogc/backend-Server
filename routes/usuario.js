...
app.put('/:id', [mdAuthentic.verificaTocken, mdAuthentic.verificaAdmin_o_MismoUsuario], (req, res) => {
...
app.delete('/:id', [mdAuthentic.verificaTocken, mdAuthentic.verificaAdmin], (req, res) => {
    var id = req.params.id;
